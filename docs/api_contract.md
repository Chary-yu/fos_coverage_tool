...
Reports generated by VNext carry immutable contract version `vnext-api-20260822.1`, the exact release identity, and a compact asset identity. Historical reports with an explicit legacy asset identity remain readable through their declared compatibility path.
