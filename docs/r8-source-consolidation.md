...
Repository branch policy after consolidation: `main` is the sole retained branch. Temporary source, CI, export, artifact, and repair branches were removed after their contents were either consolidated into `main` or superseded.
