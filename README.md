...
“开发人员待填写清单”按 Git author 的“姓名 + 邮箱”识别人员，并列出该人员在 commit 范围内提交的全部文件、关联 commit 与本人拥有的待填写新增行。多人共同提交同一文件时，文件会同时列给相关人员，页面实时刷新时按“本人拥有行 ∩ 当前 pending 行”计算；JSON/Excel 的静态责任人字段为 `Suggested Reviewer`，不等同于数据库中已确认的 reviewer。
