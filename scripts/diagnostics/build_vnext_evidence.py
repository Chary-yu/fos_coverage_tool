...
CAPABILITIES = [
    ...
    ("Path Mapping", "app/incremental/path_index.py + app/incremental/service.py",
     ["app/incremental/legacy.py", "app/legacy_runtime.py"], "app/incremental/path_index.py", "coverage_check.py CLI shim", "wired"),
